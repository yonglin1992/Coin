...
public class LogUtil {
    public static final String COIN_TAG = "CoinApp";
    public static final String PROFILE_TAG = "CoinAppProf";
    public static final String COIN_DATABASE_TAG = "CoinAppDb";
    public static final String COIN_DATABASE_PERF_TAG = "CoinAppDbPerf";
    public static final String COIN_DATAMODEL_TAG = "CoinAppDataModel";
    public static final String COIN_IMAGE_TAG = "CoinAppImage";
    public static final String COIN_NOTIFICATIONS_TAG = "CoinAppNotif";
    public static final String COIN_WIDGET_TAG = "CoinAppWidget";
     ...
     */
    public static void refreshGservices(final CoinServices gservices) {
        sCaptureDebugLogs = gservices.getBoolean(
                CoinServicesKeys.ENABLE_LOG_SAVER,
                CoinServicesKeys.ENABLE_LOG_SAVER_DEFAULT);
    ...
    public static void initializeGservices (final CoinServices gservices) {
    ...
    /**
     * Returns text as is if {@value #COIN_TAG}'s log level is set to DEBUG or VERBOSE;
    ...
    public static String sanitizePII(final String text) {
        ...
        if (android.util.Log.isLoggable(COIN_TAG, android.util.Log.DEBUG)) {
            return text;
        } else {
